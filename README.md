# DCE Analysis Platform — Alzheimer's Disease-Modifying Therapy Implementation

A simulation-based Discrete Choice Experiment (DCE) framework for evaluating stakeholder preferences in Alzheimer's disease-modifying therapy (DMT) implementation. This repository hosts the companion interactive dashboard for the Research Square preprint.
...
| Attribute | Type | Levels | Calibration |
|-----------|------|--------|-------------|
| Annual Cost to Health System | Continuous | EUR 15K; 25K; 35K; 50K | US list ~EUR 26,500 |
...
4. **WTP Analysis** — Willingness-to-pay estimates with 95% confidence intervals
...
7. **Upload Real Data** — Replace simulated coefficients with real DCE estimates via CSV upload

## Companion Paper

Sen, S.E. (2025). A Simulation-Based Discrete Choice Experiment Framework for Alzheimer's Disease-Modifying Therapy Implementation: Methodology and Interactive Decision Support Tool. *Research Square Preprint*.

## Related Repositories

- [Cost-Effectiveness Analysis — Lecanemab & Donanemab](https://github.com/sevincelifalkan-coder/cea-alzheimer-ireland)
- [AF-PROM Dashboard](https://github.com/sevincelifalkan-coder/af-prom-dashboard)
...
Copyright 2025-2026 Sevinc Elif Sen. All rights reserved.
